...
use Enable\Cors\Helpers\License;
...
final class Plugin {
	...
	/**
	 * It will load during uninstallation
	 *
	 * @return void
	 */
	...
	public static function init() {
		...
		if ( is_admin() ) {
			...
			if ( array_key_exists( 'page', $_GET ) && $_GET['page'] === 'enable-cors' ) {
				// Load script.
				...
				add_filter( 'admin_footer_text', function () {
					return 'Thank you for using <strong>Enable CORS</strong>';
				} );
	...
	public static function actions( array $actions ): array {
		$actions[] = sprintf( '<a href="%s">%s</a>', esc_url( get_admin_url( null, 'admin.php?page=enable-cors' ) ),
