                    ...
                    $content[] = '<div class="ays-quiz-dicount-wrap-box ays-quiz-dicount-wrap-text-box">';
                        $content[] = '<div>';
                            ...
                            $content[] = '<span class="ays-quiz-new-mega-bundle-desc">';
                                $content[] = '<img class="ays-quiz-new-mega-bundle-guaranteeicon" src="' . AYS_QUIZ_ADMIN_URL . '/images/quiz-maker-guaranteeicon.webp" style="width: 30px;">';
                                $content[] = __( "30 Day Money Back Garantee", AYS_QUIZ_NAME );
                            $content[] = '</span>';
                        $content[] = '</div>';
